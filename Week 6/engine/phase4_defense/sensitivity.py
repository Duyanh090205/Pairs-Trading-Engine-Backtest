...
def _apply_stop_loss_posthoc(
    ...
    """
    import pandas as pd
    from engine.utils.metrics import compute_sharpe, compute_max_dd, compute_cagr
...
def run_structural_oat_fold(
    ...
    from engine.utils.io import read_1min
...
def compute_exit_reasons(logs_dir: Path | None = None) -> pd.DataFrame:
    ...
    """
    from engine.phase4_defense.orchestrator import _LOGS_DIR
    if logs_dir is None:
        logs_dir = _LOGS_DIR
